...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('shop_id')->comment('ショップID');
            $table->timestamps();
        });
        DB::table('users')->insert(['id' => 1, 'name' => '最高権力者A太郎', 'email' => 'sute1@example.com',
            'password' => bcrypt('password'), 'birthdate' => '2001-4-22', 'tel' => '09011111111', 'zip_code' => '120-0001', 
            'prefecture' => '東京都', 'city' => '千代田区', 'unique_name' => '千代田1-4-2', 'shop_id' => '999',
            ]);
        DB::table('users')->insert(['id' => 2, 'name' => '店管理者B子', 'email' => 'sute2@example.com',
            'password' => bcrypt('password'), 'birthdate' => '1998-9-2', 'tel' => '09022222222', 'zip_code' => '140-1124', 
            'prefecture' => '愛知県', 'city' => '千代田区', 'unique_name' => '千代田1-4-2', 'shop_id' => '1',
            ]);
        DB::table('users')->insert(['id' => 3, 'name' => '一般C太', 'email' => 'sute3@example.com',
            'password' => bcrypt('password'), 'birthdate' => '1972-4-22', 'tel' => '09022222222', 'zip_code' => '302-2321', 
            'prefecture' => '大阪府', 'city' => '大阪市', 'unique_name' => '大淀北1-44-1', 'shop_id' => '10',
            ]);           
